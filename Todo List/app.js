...
function filter(e){
    ...
    if(todoListesi.length>0){
        ...
        showAlert("warning","at least one todo must be for filter");
    }
...
function allTodosEverywhere(){
   ...
   if(todoListesi.length>0){
    ...
    showAlert("success","It was deleted succesfully!");
   }else{
    showAlert("warning","at least one todo must be for delete");
   }
}
